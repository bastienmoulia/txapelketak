...
@Component({
  ...
  template: `
    @switch (name()) {
      ...
      @case ('euro') {
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
          <path d="M13,20.75h-.15a8.75,8.75,0,0,1-5.93-15,8.54,8.54,0,0,1,6.23-2.46,8.75,8.75,0,0,1,6,2.5.75.75,0,0,1,0,1.06.75.75,0,0,1-1.06,0,7.26,7.26,0,1,0-.19,10.53l.22-.21a.79.79,0,0,1,1.09,0,.7.7,0,0,1,.05,1l-.05.05-.29.28A8.72,8.72,0,0,1,13,20.75Z" />
      ...
      @case ('code') {
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
          <path d="M9.53,6.47a.75.75,0,0,0-1.06,0l-5,5a.75.75,0,0,0,0,1.06l5,5a.75.75,0,0,0,1.06,0,.75.75,0,0,0,0-1.06L5.06,12,9.53,7.53A.75.75,0,0,0,9.53,6.47Z" />
          <path d="M20.53,11.47l-5-5a.75.75,0,0,0-1.06,1.06L18.94,12l-4.47,4.47a.75.75,0,0,0,0,1.06.75.75,0,0,0,1.06,0l5-5A.75.75,0,0,0,20.53,11.47Z" />
        </svg>
      }
      @case ('plus') {
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
          <path d="M12.75,11.25V5a.75.75,0,0,0-1.5,0v6.25H5a.75.75,0,0,0,0,1.5h6.25V19a.76.76,0,0,0,.75.75.75.75,0,0,0,.75-.75V12.75H19a.75.75,0,0,0,.75-.75.76.76,0,0,0-.75-.75Z" />
        </svg>
      }
      @case ('list') {
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
          ...
          <path d="M5,8.5a1,1,0,0,1-.38-.07,1.46,1.46,0,0,1-.33-.22A1,1,0,0,1,4,7.5a1.05,1.05,0,0,1,.29-.71.93.93,0,0,1,.33-.21,1,1,0,0,1,.76,0,1,1,0,0,1,.33.21A1.05,1.05,0,0,1,6,7.5a1,1,0,0,1-.29.71,1.46,1.46,0,0,1-.33.22A1,1,0,0,1,5,8.5Z" />
          <path d="M5,13a1,1,0,0,1-.38-.08,1.15,1.15,0,0,1-.33-.21A1,1,0,0,1,4,12a1.05,1.05,0,0,1,.29-.71,1.15,1.15,0,0,1,.33-.21A1,1,0,0,1,5.2,11l.18.06.18.09a1.58,1.58,0,0,1,.15.12A1.05,1.05,0,0,1,6,12a1,1,0,0,1-1,1Z" />
          <path d="M5,17.5a1,1,0,0,1-.38-.07,1.46,1.46,0,0,1-.33-.22,1.15,1.15,0,0,1-.21-.33.94.94,0,0,1,0-.76,1.15,1.15,0,0,1,.21-.33,1,1,0,0,1,1.09-.21,1,1,0,0,1,.33.21,1.15,1.15,0,0,1,.21.33.94.94,0,0,1,0,.76,1.15,1.15,0,0,1-.21.33A1,1,0,0,1,5,17.5Z" />
        </svg>
      }
      @case ('sun') {
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
